...
function resetCamera() {
   ...
   *                   🚗 -----> +Z
   *
   * Camera = behind the rear wing + above it.
   */
  targetCamera
    .copy(wingWorld)
  ...
  // Look over the car toward its front.
  lookTarget
    .copy(wingWorld)
...
function updateCamera(dt) {
  ...
  // Camera position is ALWAYS calculated from Plane.067.
  // Therefore it follows the rear wing, not the track.
  targetCamera
    .copy(wingWorld)
    .addScaledVector(forward, -6.5);
